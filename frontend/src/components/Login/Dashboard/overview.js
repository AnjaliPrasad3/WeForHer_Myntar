      ...
      <Fragment>
          <div>
              ...
              <div className=' w-[70%] h-full 2xl:w-[80%] xl:w-[80%] lg:w-[80%] '>
                ...
                <div className='w-[60%]'>
                <h1 className='my-4'>Anjali</h1>
                <h1 className='my-4'>9073649047</h1>
                <h1 className='my-4'>anjali@gmail.com</h1>
                <h1 className='my-4'>Female</h1>
                <h1 className='my-4'>03/3/2002</h1>
                <h1 className='my-4'>Ranchi</h1>
                </div>
                </div>
